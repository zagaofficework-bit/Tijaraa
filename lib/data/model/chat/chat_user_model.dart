...
class ChatUser {
  ...
  int? unreadCount;
  // **********************************************
  // ADDED PROPERTY FOR COMBINED CHAT LIST CUBIT
  bool? isBuyerChat;
  // **********************************************
  ...
  ChatUser({
    ...
    this.item,
    this.unreadCount,
    this.isBuyerChat, // Initialize the new property
  });
  ...
  ChatUser.fromJson(Map<String, dynamic> json) {
    ...
    // Note: isBuyerChat is NOT from the API, so it's not set here.
    // It will be set in the ChatRepository when loading the list.
  }
  ...
  // **********************************************
  // UPDATED copyWith to include isBuyerChat
  // **********************************************
  ChatUser copyWith({
    int? unreadCount,
    String? createdAt,
    ...
    isBuyerChat: isBuyerChat ?? this.isBuyerChat, // Copy or replace
  );
}
