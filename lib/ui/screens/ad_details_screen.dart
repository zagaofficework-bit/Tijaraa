...
import 'package:Tijaraa/data/cubits/item/fetch_item_from_slug_cubit.dart';
...
import 'package:Tijaraa/data/cubits/report/fetch_item_report_reason_list.dart';
...
import 'package:Tijaraa/data/model/item/job_application.dart'
    show JobApplication;
...
import 'package:Tijaraa/ui/screens/google_map_screen.dart';
...
import 'package:Tijaraa/ui/screens/widgets/video_view_screen.dart';
...
class AdDetailsScreen extends StatefulWidget {
  ...
  const AdDetailsScreen({super.key, this.model, this.slug});
...
class AdDetailsScreenState extends CloudState<AdDetailsScreen> {
  ...
  Widget itemData(
    int index,
    SubscriptionPackageModel model,
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return itemData(
                                index,
                                state.subscriptionPackages[index],
                                setStater,
                              );
                            },
                              ...
                              child: UiUtils.buildButton(
                                ...
                                onPressed: () {
                                  if (state
                                    ...
                                    HelperUtils.showSnackBarMessage(
                                      context,
                                      "pleasePurchasePackage".translate(
                                        context,
                                      ),
                                    );
                                    Navigator.pushNamed(
