...
import 'package:Tijaraa/ui/screens/chat/chat_audio/audio_state.dart';
import 'package:Tijaraa/ui/screens/chat/chat_audio/globals.dart';
import 'package:Tijaraa/ui/screens/chat/chat_audio/widgets/flow_shader.dart';
import 'package:Tijaraa/ui/screens/chat/chat_audio/widgets/lottie_animation.dart';
...
class RecordButton extends StatefulWidget {
  // FIX: Removed conflicting/redundant parameters 'recordButtonAnimation' and 'onUpload'.
  // Only keep the parameters that are actually used as fields.
  const RecordButton({
    super.key,
  ...
  // This is the function signature that should be called 'callback' in chat_screen.dart
...
// ... (rest of the State class remains unchanged)
  ...
  void dispose() {
    record.dispose();
    // FIX: Wrap the controller dispose in a try-catch to prevent "called more than once" crash.
    try {
      widget.controller.dispose();
    } on FlutterError catch (e) {
      // We only suppress the double-dispose error.
      if (!e.message.contains('AnimationController.dispose() called more than once')) {
        rethrow;
      }
    }
    timer?.cancel();
