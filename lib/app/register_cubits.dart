...
import 'package:Tijaraa/data/cubits/auth/login_cubit.dart';
import 'package:Tijaraa/data/cubits/category/fetch_category_cubit.dart';
import 'package:Tijaraa/data/cubits/category/fetch_sub_categories_cubit.dart';
...
import 'package:Tijaraa/data/cubits/chat/make_an_offer_item_cubit.dart';
import 'package:Tijaraa/data/cubits/chat/send_message.dart';
import 'package:Tijaraa/data/cubits/chat/unblock_user_cubit.dart';
import 'package:Tijaraa/data/cubits/company_cubit.dart';
...
import 'package:Tijaraa/data/cubits/favorite/manage_fav_cubit.dart';
import 'package:Tijaraa/data/cubits/fetch_blogs_cubit.dart';
import 'package:Tijaraa/data/cubits/fetch_faqs_cubit.dart';
import 'package:Tijaraa/data/cubits/fetch_item_buyer_cubit.dart';
import 'package:Tijaraa/data/cubits/fetch_my_reviews_cubit.dart';
...
import 'package:Tijaraa/data/cubits/item/change_my_items_status_cubit.dart';
import 'package:Tijaraa/data/cubits/item/create_featured_ad_cubit.dart';
import 'package:Tijaraa/data/cubits/item/delete_item_cubit.dart';
import 'package:Tijaraa/data/cubits/item/fetch_item_from_category_cubit.dart';
...
import 'package:Tijaraa/data/cubits/item/fetch_popular_items_cubit.dart';
import 'package:Tijaraa/data/cubits/item/item_total_click_cubit.dart';
import 'package:Tijaraa/data/cubits/item/job_application/fetch_job_application_cubit.dart';
import 'package:Tijaraa/data/cubits/item/related_item_cubit.dart';
import 'package:Tijaraa/data/cubits/item/search_item_cubit.dart';
...
import 'package:Tijaraa/data/cubits/my_item_review_report_cubit.dart';
import 'package:Tijaraa/data/cubits/renew_item_cubit.dart';
import 'package:Tijaraa/data/cubits/report/item_report_cubit.dart';
import 'package:Tijaraa/data/cubits/report/update_report_items_list_cubit.dart';
import 'package:Tijaraa/data/cubits/safety_tips_cubit.dart';
import 'package:Tijaraa/data/cubits/seller/fetch_seller_item_cubit.dart';
import 'package:Tijaraa/data/cubits/seller/fetch_seller_ratings_cubit.dart';
...
import 'package:Tijaraa/data/cubits/subscription/bank_transfer_update_cubit.dart';
import 'package:Tijaraa/data/cubits/subscription/fetch_ads_listing_subscription_packages_cubit.dart';
import 'package:Tijaraa/data/cubits/subscription/fetch_featured_subscription_packages_cubit.dart';
import 'package:Tijaraa/data/cubits/subscription/fetch_user_package_limit_cubit.dart';
import 'package:Tijaraa/data/cubits/subscription/in_app_purchase_cubit.dart';
...
import 'package:Tijaraa/data/cubits/system/get_api_keys_cubit.dart';
import 'package:Tijaraa/data/cubits/system/language_cubit.dart';
import 'package:Tijaraa/data/cubits/system/notification_cubit.dart';
import 'package:Tijaraa/data/cubits/system/user_details.dart';
import 'package:Tijaraa/data/cubits/utility/fetch_transactions_cubit.dart';
import 'package:Tijaraa/data/cubits/utility/item_edit_global.dart';
import 'package:Tijaraa/data/repositories/item/favourites_repository.dart';
...
class RegisterCubits {
  List<SingleChildWidget> providers = [
    ...
    BlocProvider(create: (_) => LeafLocationCubit(), lazy: false),
  ];
}
